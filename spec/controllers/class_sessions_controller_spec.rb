...
describe ClassSessionsController do
  ...
  describe "GET index" do
    it "assigns all class_sessions as @class_sessions" do
      class_session = ClassSession.create! valid_attributes
      get :index, {}, valid_session
      assigns(:class_sessions).should eq([class_session])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested class_session as @class_session" do
      ...
      assigns(:class_session).should eq(class_session)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new class_session as @class_session" do
      ...
      assigns(:class_session).should be_a_new(ClassSession)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created class_session as @class_session" do
        post :create, {:class_session => valid_attributes}, valid_session
        assigns(:class_session).should be_a(ClassSession)
        assigns(:class_session).should be_persisted
      end

      it "redirects to the created class_session" do
        post :create, {:class_session => valid_attributes}, valid_session
        response.should redirect_to(ClassSession.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved class_session as @class_session" do
        ...
        ClassSession.any_instance.stub(:save).and_return(false)
        post :create, {:class_session => { "room_id" => "invalid value" }}, valid_session
        assigns(:class_session).should be_a_new(ClassSession)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested class_session" do
        ...
        ClassSession.any_instance.should_receive(:update).with({ "room_id" => "1" })
        put :update, {:id => class_session.to_param, :class_session => { "room_id" => "1" }}, valid_session
      end
      ...
      it "redirects to the class_session" do
        class_session = ClassSession.create! valid_attributes
        put :update, {:id => class_session.to_param, :class_session => valid_attributes}, valid_session
        response.should redirect_to(class_session)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the class_session as @class_session" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ClassSession.any_instance.stub(:save).and_return(false)
        put :update, {:id => class_session.to_param, :class_session => { "room_id" => "invalid value" }}, valid_session
        assigns(:class_session).should eq(class_session)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the class_sessions list" do
      class_session = ClassSession.create! valid_attributes
      delete :destroy, {:id => class_session.to_param}, valid_session
      response.should redirect_to(class_sessions_url)
    end
  end
