...
describe SchoolsController do
  ...
  let(:valid_attributes) { { "headmaster_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved school as @school" do
        ...
        post :create, {:school => { "headmaster_id" => "invalid value" }}, valid_session
        assigns(:school).should be_a_new(School)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested school" do
        ...
        School.any_instance.should_receive(:update).with({ "headmaster_id" => "1" })
        put :update, {:id => school.to_param, :school => { "headmaster_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the school as @school" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        School.any_instance.stub(:save).and_return(false)
        put :update, {:id => school.to_param, :school => { "headmaster_id" => "invalid value" }}, valid_session
        assigns(:school).should eq(school)
      end
